...
export const metadata: Metadata = {
  ...
  keywords: ["bouquet builder", "flowers", "floral design", "custom bouquet"],
  openGraph: {
    title: "BloomCraft — Build Your Perfect Bouquet",
    description: "Design your dream bouquet with BloomCraft.",
    type: "website",
  },
};
